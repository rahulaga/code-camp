...
public class Hello {
	...
	public String sayHelloJSON(@PathParam(value="name") String name) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/name/{name}")
	public String sayPut(@PathParam(value="name") String name, String body ) {
		System.out.println(body);
		return "{\"hello\":\"Hello Code Camp+"+name+"\"}";
	}
